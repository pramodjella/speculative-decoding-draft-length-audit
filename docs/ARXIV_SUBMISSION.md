...
standalone from a clean directory (10 pages — 9 of main content, references running onto
the tenth — 5 figures, pdflatex ×3, no external .bib,
...
- **Comments field:** worth stating the artifact position, e.g.
  *"10 pages, 5 figures. All numbers reproduce from released raw JSON; benchmarking protocol
...
days (short) and 104 (long). Their 12-page cutoff counts main content, not references; at 9
pages of main content we are under it, so reviews are due
