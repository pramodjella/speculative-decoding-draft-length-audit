...
\author{
% Titles dropped: ML venues do not use them in the byline. Affiliation restored 2026-09-15 on
% Naman's confirmation that Vizuara AI Labs is the one to list; all six authors share it, so a
