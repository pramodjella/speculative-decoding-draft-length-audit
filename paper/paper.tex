...
recover $-2.7$ to $8.5\%$ of the span, nor in token position, which recovers exactly zero. It is
...
barely persists. Across the 1{,}295 decode steps of the signal capture behind this harness,
the accept-run distribution is heavily
